...
public class FileWritersJavaIo {
    ...
    public static void main(String[] args) {
        ...
        try (PrintStream ps = new PrintStream("C:/Users/sifis/ideaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file-ps.txt")) {
//            fileWriter("C:/Users/sifis/ideaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file.txt");
//            bufferedWritter(file);

            sayHello(System.out);
            sayHello(ps);
        } catch (IOException e) {
            System.out.println("To arxeio den dimioyrgithike h kapoio lathos sinebi kata tin eggrafi");
        }
    }
    ...
    public static void bufferedWritter(File file) throws IOException {
