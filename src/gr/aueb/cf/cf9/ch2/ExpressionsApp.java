...
public class ExpressionsApp {
    ...
    public static void main(String[] args){
        ...
        mod = num1 % num2;  // Το υηολοιπο της διαιρεσης

        System.out.printf("Sum: %d, Sub: %d, Mul: %d, Div: %d, Mod: %d\n", sum, sub, mul, div, mod);

        result1 = result1 + 1; // Αλλαζει η τιμη του result1 -> 1
        result2 += 1;          // result2 = result2 + 1
        result3 ++;            // result3 = result3 + 1, result3 += 1

        System.out.printf("Result: %d, Result2 %d, Result3 %d\n", result1, result2, result3);

        result4 = num1++;      // result4 -> 12, num1 -> 12
